...
# z_y1
random_states = [436,81,61,787,807]
# z_y2
...
joblib.dump(best_equal_stacking_model, 'best_equal_stacking_model_z_y1.pkl')
print(f"\n已保存最佳等权堆叠模型，训练R²: {best_train_r2:.4f} 到 best_equal_stacking_model_z_y2.pkl")
